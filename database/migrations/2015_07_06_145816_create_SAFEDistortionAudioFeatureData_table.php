...
class CreateSAFEDistortionAudioFeatureDataTable extends Migration {
	...
	public function up()
	{
		Schema::create('SAFEDistortionAudioFeatureData', function(Blueprint $table)
		{
	...
	{
		Schema::drop('SAFEDistortionAudioFeatureData');
	}
