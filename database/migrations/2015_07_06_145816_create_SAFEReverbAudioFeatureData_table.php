...
class CreateSAFEReverbAudioFeatureDataTable extends Migration {
	...
	public function up()
	{
		Schema::create('SAFEReverbAudioFeatureData', function(Blueprint $table)
		{
	...
	{
		Schema::drop('SAFEReverbAudioFeatureData');
	}
