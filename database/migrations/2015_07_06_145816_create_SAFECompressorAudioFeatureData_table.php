...
class CreateSAFECompressorAudioFeatureDataTable extends Migration {
	...
	public function up()
	{
		Schema::create('SAFECompressorAudioFeatureData', function(Blueprint $table)
		{
	...
	{
		Schema::drop('SAFECompressorAudioFeatureData');
	}
